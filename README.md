...
- 🌱 I’m currently learning **Django**, **React**, **Wordpress**, **Htmx**, **Hyperscript** **Webpack** **Alpinejs** and **Fastapi**
...
<img src="https://skillicons.dev/icons?i=html,css,js,vim,vscode,git,c,php,python,go,bash,github,pycharm,flask,django,linux,neovim,bootstrap,tailwind,arch,debian,ubuntu,electron,dart,markdown,mint,figma,sublime,mysql,react,ruby,discord,powershell,wordpress,fastapi,htmx,webpack,alpinejs">
<h3>Stats</h3>
